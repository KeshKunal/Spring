# 🌸 Spring - Mental Health Wellness Platform
...
The following technologies are used in Spring:
...
1. Clone the repository to your local machine using the following command:
   ...
   ```bash
   git clone https://github.com/Spring-A-Mental-Wellness-Platform/website.git
   ```
...
We welcome contributions to Spring! If you'd like to contribute, please follow these steps:
